/************************************************************************
 *   IRC - Internet Relay Chat, util/chkconf.c (was ircd/chkconf.c)
...
#ifndef lint
static  char rcsid[] = "@(#)$Id: chkconf.c,v 1.1.1.1 1997/07/23 18:02:03 cbehrens Exp $";
#endif
...
#define DupString(x,y) do{x=malloc(strlen(y)+1);(void)strcpy(x,y);}while(0)
